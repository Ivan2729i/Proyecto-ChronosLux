...
urlpatterns = [
    ...
    path('mis-domicilios/editar/<str:domicilio_id>/', domicilio_edit, name='domicilio_edit'),
    path('mis-domicilios/eliminar/<str:domicilio_id>/', domicilio_delete, name='domicilio_delete'),

    path('mis-compras/', mis_compras, name='mis_compras'),
    path('mis-compras/devolucion/<str:pedido_id>/', solicitar_devolucion, name='solicitar_devolucion'),
